/**
 * Secret Leak Guard (.agents/plugins/myhomestock/hooks/secretLeakGuard.js)
 * Comprehensive Secret & Credential Leak Scanner
 * Can be run standalone or invoked via qualityGateRunner.
 */
...
export function scanSecrets(projectRoot) {
