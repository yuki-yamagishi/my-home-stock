...
詳細は [docs/issues/ISSUE-006_migrate_to_antigravity_review_loop_plugin/pre_verification.md](./issues/ISSUE-006_migrate_to_antigravity_review_loop_plugin/pre_verification.md) を参照。
